...
#ifndef APPLICATION_KALMANVARIO_PVA_H_
#define APPLICATION_KALMANVARIO_PVA_H_
...
/**
 * @brief Kalman-filter-based sensor fusion observer
 *
 * Blend vertical acceleration inclusive gravity with GNSS position and speed data
 * to provide UN-compensated variometer plus vertical net acceleration w/o gravity
 */

class KalmanVario_PVA_t
{
private:
  ...
  enum
  {
    ...
    L = 3  //!< number of measurement channels = { altitude, vertical_acceleration_measurement }
  };
...
#endif /* APPLICATION_KALMANVARIO_PVA_H_ */

...
#ifndef APPLICATION_VA_OBSERVER_H_
#define APPLICATION_VA_OBSERVER_H_
...
private:
  ...
  enum
  {
    N = 2,  //!< size of state vector x = { altitude, vario, vertical-acceleration, acceleration-offset }
